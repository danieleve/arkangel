...
import com.arkangel.arkangel.Activitys.ResultadoTest;
...
public class menu17Fragment extends Fragment {

    private TextView seleccionado;

    public menu17Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myview = inflater.inflate(R.layout.fragment_menu, container, false);
         final  GetTest getTest= new GetTest();
        Question question= new Question();
        question= getTest.getQuestion(17);
        ...
        desliza.setImageResource(R.drawable.next);
        desliza.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                getTest.saveTest();
                Intent intent = new Intent(getActivity(), ResultadoTest.class);
